const games = [
  {
    ...
    image: '/assets/images/beans.png', // 'https://media.giphy.com/media/xUNda3pLJEsg4Nedji/giphy.gif',
    description:
  ...
  },
  {
    id: 'chess-pie',
    name: 'Chess Pie',
    image: '/assets/images/chess.png', // 'https://media.giphy.com/media/iCZyBnPBLr0dy/giphy.gif',
  ...
  },
  {
    id: 'purrfection',
    name: 'Purrfection',
    image: '/assets/images/cat.png', // 'https://media.giphy.com/media/12xMvwvQXJNx0k/giphy.gif',
